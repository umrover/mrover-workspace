#include "gimbalSpiralOutSearch.hpp"
...
GimbalSpiralOut::~GimbalSpiralOut() {}

void GimbalSpiralOut::GimbalSpiralOut( Rover* phoebe, const rapidjson::Document& roverConfig, const double visionDistance )
{
    mSearchPoints.clear();
