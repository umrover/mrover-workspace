/****************************************************************
 * ICM-20948 IMU data output using DMP
 * Adapted from Adafruit example code by:
...
void setup()
{
  ...
  // Initialize the IMU, repeat until successful
...
void loop()
{
  ...
  if ((myICM.status == ICM_20948_Stat_Ok) || (myICM.status == ICM_20948_Stat_FIFOMoreDataAvail))
  {
    ...
    if ((data.header & DMP_header_bitmap_Quat9) > 0)
    {
      ...
      SERIAL_PORT.print(roll * 180/PI, 3);
      SERIAL_PORT.print(F(" Yaw:"));
      SERIAL_PORT.print(yaw * 180/PI, 3);
      SERIAL_PORT.print(F(" Bearing:"));
      SERIAL_PORT.print(bearing, 3);
...
// This function is defined as __attribute__((weak)) so we are overwriting it here to set our own FSR values
