...
def main():
    ...
    with open('/home/debian/mrover-workspace/beaglebone/imu/src/mag_calibration.txt', 'r') as mag_calibration:
    ...
    with open('/home/debian/mrover-workspace/beaglebone/imu/src/ag_calibration.txt', 'r') as ag_calibration:
    ...
    while(True):
        ...
        # Raw Data
        f = open('/home/debian/mrover-workspace/beaglebone/imu/src/accel.txt', 'a')
        print("Accel Raw: ", data[imu.XACCEL] / 2048, ",", data[imu.YACCEL] / 2048, ",", data[imu.ZACCEL] / 2048)
        f.write("time: " + str(t.clock() - start) + " x: " + str(data[imu.XACCEL] / 2048) + ", y: " + str(data[imu.YACCEL]/2048) + ", z: " + str(data[imu.ZACCEL]/2048) + '\n')
