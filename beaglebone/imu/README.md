...
![](https://github.com/jjtom34/mrover-workspace/tree/imu/beaglebone/imu/IMU.PNG) \
Copy the values in the left column into the calibration.txt file that can be found in the IMU src code. \
