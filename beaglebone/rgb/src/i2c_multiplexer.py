...
TCA9548A_SWITCH_CHANNEL = 0x04 #apparently this is the address for switching channels https://www.raspberrypi.org/forums/viewtopic.php?t=146416
...
#           ie 0x01 talks to 0 only, 0x02 talks to 1 only, 0x04 talks to 2 only... 0x40 talks to 8 only
#           IF you want to write to multiple rgb sensors you can "combine" the above ie 0x02 + 0x01 = 0x03 will write to 0 AND 1.
