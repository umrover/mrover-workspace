<template>
  <div class="wrap">
    ...
    <div class="input">
          ...
          Camera number: <input type='Number' v-model ='cameraIdx'>
    ...
    <div class="cameraselection">
      <CameraSelection class="cameraspace1" v-bind:cam_index="cam_index_1" v-bind:names="names" v-on:cam_index="setCamIndex($event, 1)"/>
      <CameraSelection class="cameraspace2" v-bind:cam_index="cam_index_2" v-bind:names="names" v-on:cam_index="setCamIndex($event, 2)"/>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      addCameraName: function() {
        this.names.splice(0, this.cameraIdx, this.cameraName)
        console.log(this.cameraIdx)
        console.log("hello");
      }
    },
