    ...
    data () {
      return {
        ...
        subscriptions: [
          ...
          {'topic': '/arm_slow_mode', 'type': 'Enable'},
          ...
          {'topic': '/auton_enabled', 'type': 'Enable'},
          {'topic': '/autonomous', 'type': 'Joystick'},
          {'topic': '/auton_led', 'type': 'AutonLed'},
          ...
          {'topic': '/heater_auto_shutdown_cmd', 'type': 'Enable'},
          ...
          {'topic': '/teleop_enabled', 'type': 'Enable'},
