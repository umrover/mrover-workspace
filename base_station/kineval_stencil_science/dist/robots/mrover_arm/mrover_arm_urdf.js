...
robot.joints.joint_a.origin = {xyz: [0.0,-1.4234*scale_factor,1.585*scale_factor], rpy:[0,0,0]};
robot.joints.joint_a.axis = [1.0,0.0,0];   
robot.joints.joint_a.type = "continuous";

robot.joints.joint_b = {parent:"a-b", child:"b-c"};
robot.joints.joint_b.origin = {xyz: [0.0,0.8841*scale_factor,11.125*scale_factor], rpy:[0,0,0]};
...
robot.endeffector = {};
robot.endeffector.frame = "joint_e";
