...
const getters = {
  ...
  noisePercent: (fieldState:FieldState):number => fieldState.noisePercent,
...
const mutations = {
  ...
  setNoise: (fieldState:FieldState, newNoisePercent:number):void => {
    fieldState.noisePercent = newNoisePercent;
  },
  ...
  setFieldState: (fieldState:FieldState, newState:FieldState):void => {
    ...
    fieldState.noisePercent = newState.noisePercent;
